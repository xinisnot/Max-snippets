...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									"code" : "//============================================================\r\n// functions\n\nscaleU2X(x, from, to)\n{\n    return x * (to-from) + from;\n}\n\nscaleX2U(x, from, to)\n{\n    return (x-from) / (to-from);\n}\n\ncurveExp(x, from, to, amt)\n{\n    return amt>0 ? scaleU2X(exp(ln(x) * (1/(1-amt))), from, to)\n                 : scaleU2X(exp(ln(x) * (1+amt)),     from, to);\n}\n\nsmooExp(tgt, samps, cAmt, ioCurve)\n{\n    History d(0);\n    History y(1);\n    History c(0);\n    History io(0);\n    History tgt1(0);\r\n    History tgtM(0);\n    History ret1(0);\n\n    if(change(tgt))\n    {\n        y    = samps!=0 ? 0 : 1;\n        d    = 1/samps;\n        c    = (cAmt<1 && cAmt>-1) ? cAmt : cAmt*0.999;\n        io   = ioCurve;\n        tgt1 = ret1;\r\n        tgtM = (tgt+tgt1)*0.5;\n    }\n\n    ret0 = 0;\n\n    if(io==0)\n    {\n        ret0 = curveExp(y, tgt1, tgt, c);\n    }\n    else\n    {\n        ret0 = y<0.5 ? curveExp(scaleX2U(y, 0, 0.5), tgt1, tgtM, c)\n                     : curveExp(scaleX2U(y, 0.5, 1), tgtM, tgt, -c);\n    }\n\n    ret1 = ret0;\n\n    if(y<1)\n    {\n        y += d;\n    }\n\n    return ret0;\n}\n\n//============================================================\n// parameters\n\nParam time(1000, min=0);\nParam curve(0, min=-1, max=1);\nParam io(0);\n\n//============================================================\n// main loop\n\nout1 = smooExp(in1, mstosamps(time), curve, io);",
									"fontface" : 0,
									"fontname" : "<Monospaced>",
									"fontsize" : 12.0,
									"id" : "obj-5",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 260.0, 10.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 260.0, 40.0, 38.0, 21.0 ],
					"text" : "io $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 190.0, 10.0, 50.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 190.0, 40.0, 56.0, 21.0 ],
					"text" : "curve $1"
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 139.5, 105.0, 19.5, 105.0 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-15", 0 ],
					"midpoints" : [ 269.5, 105.0, 19.5, 105.0 ],
					"source" : [ "obj-4", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-15", 0 ],
					"midpoints" : [ 199.5, 105.0, 19.5, 105.0 ],
					"source" : [ "obj-5", 0 ]
				}
