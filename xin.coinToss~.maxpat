...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 10.0, 140.0, 56.0, 21.0 ],
					"sig" : 0.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 70.0, 50.0, 50.0, 21.0 ],
					"text" : "prob $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 10.0, 50.0, 44.0, 21.0 ],
					"text" : "click~"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									"code" : "//============================================================\n// Returns 0 or 1 probabilistically.\n\n//============================================================\n// functions\n\ncoinToss(trig, prob)\n{\n    History y(0);\n\n    if(trig!=0)\n    {\n        y = (noise()+1) * 0.5 < prob;\n    }\n\n    return y;\n}\n\n//============================================================\n// parameters\n\nParam prob(0.5, min=0, max=1);\n\n//============================================================\n// main loop\n\nout1 = coinToss(in1, prob);",
									"fontface" : 0,
									"fontname" : "<Monospaced>",
									"fontsize" : 12.0,
									"id" : "obj-5",
