...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"activelinecolor" : [ 0.196078431372549, 0.698039215686274, 1.0, 1.0 ],
					"id" : "obj-4",
					"maxclass" : "live.scope~",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 							{
								"box" : 								{
									"code" : "//============================================================\n// Split the positive and negative components.\n\n//============================================================\n// functions\n\nsplitPN(x)\n{\n    pos, neg = gate((x<0) + 1, x, choices=2);\n    return pos, neg;\n}\n\n//============================================================\n// main loop\n\nout1, out2 = splitPN(in1);",
									"fontface" : 0,
									"fontname" : "<Monospaced>",
									"fontsize" : 12.0,
									"id" : "obj-5",
