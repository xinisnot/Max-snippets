...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 10.0, 310.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 10.0, 160.0, 32.0, 130.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 50.0, 80.0, 44.0, 21.0 ],
					"text" : "pan $1"
				}
...
, 							{
								"box" : 								{
									"code" : "//============================================================\r\n// Constant power panning.\r\n\r\n//============================================================\n// functions\r\n\r\nscaleU2X(x, from, to)\n{\n    return x * (to-from) + from;\n}\n\nsmoo(tgt, samps)\n{\n    History d(0);\n    History y(0);\n    History tgt1(0);\n    History ret1(0);\n\n    if(change(tgt))\n    {\n        y    = samps!=0 ? 0 : 1;\n        d    = 1 / samps;\n        tgt1 = ret1;\n    }\n\n    ret0 = scaleU2X(y, tgt1, tgt);\n    ret1 = ret0;\n\n    if(y<1)\n    {\n        y += d;\n    }\n\n    return ret0;\n}\n\npan2(x, pan)\n{\n    coeff_l = cycle(pan*0.125 + 0.125, index=\"phase\");\n    coeff_r = cycle(pan*0.125 + 0.875, index=\"phase\");\n\n    return x*coeff_l, x*coeff_r;\n}\n\n//============================================================\n// parameters\n\nParam pan(0, min=-1, max=1);\n\n//============================================================\n// main loop\n\nout1, out2 = pan2(in1, smoo(pan, 100));",
									"fontface" : 0,
									"fontname" : "<Monospaced>",
									"fontsize" : 12.0,
									"id" : "obj-5",
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 1 ],
					"midpoints" : [ 22.0, 302.5, 45.5, 302.5 ],
					"source" : [ "obj-7", 1 ]
				}
